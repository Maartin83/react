                ...
                <section className="bg-light p-5 text-center" id={"Inicio"}>
                    <div className="row d-flex justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <p>
                                Clínica Dental La Merced es una empresa con más de 20 años de experiencia Odontológica, brindado calidad en el servicio.

                                Actualmente contamos con cuatro sedes que están ubicados estratégicamente en las zonas de mayor dinámica comercial de Lima Este (Ceres Vitarte y Huaycan).
                            </p>
                        </div>
                        <div className="elementor-widget-container">
                            ...
                            <img
                                ...
                                width="600"
                                height="800"
                                src="https://dentallamerced.com/wp-content/uploads/2022/08/nosotros-la-merced.jpg"
                                className="attachment-full size-full wp-image-65"
                                alt="Odontologos Dental La Merced"
                                srcSet="https://dentallamerced.com/wp-content/uploads/2022/08/nosotros-la-merced.jpg 500w, https://dentallamerced.com/wp-content/uploads/2022/08/nosotros-la-merced-214x300.jpg 214w"
                            ...
                            <div className="col-6">
                                ...
                                <form>
                                    <div className="d-flex justify-content-center">
                                        <a href="https://www.facebook.com/dentallamerced" target={"_blank"} rel={"noreferrer"} className="btn  m-2" style={{backgroundColor:"#FFA500"}}>
                                            <FontAwesomeIcon icon={faFacebook} /> Facebook
                                        </a>
                                        <a href="https://api.whatsapp.com/send/?phone=51993730231&text=Hola%20Dental%20La%20Merced,%20deseo%20sacar%20una%20cita.%20https://dentallamerced.com/" target={"_blank"} rel={"noreferrer"} className="btn  m-2" style={{backgroundColor:"#FFA500"}}>
                                            <FontAwesomeIcon icon={faWhatsapp} /> Whatsapp
                                        </a>
                                        <a href="https://www.instagram.com/dentallamerced/" target={"_blank"} rel={"noreferrer"} className="btn m-2" style={{backgroundColor:"#FFA500"}}>
                                            <FontAwesomeIcon icon={faInstagram} /> Instagram
                                        </a>
                                        <a href="https://www.tiktok.com/@dentallamerced" target={"_blank"} rel={"noreferrer"} className="btn  m-2" style={{backgroundColor:"#FFA500"}}>
                        ...
                        <div style={{ width: '100%', maxHeight:"600px", margin: '0 auto' }}>
                            <div style={{ position: 'relative', paddingBottom: '75%' /* Proporción del aspecto del mapa (4:3) */ }}>
                                <iframe
                                    ...
                                    frameBorder="0"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15608.710426513715!2d-76.94292978017783!3d-12.031290782616473!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c589037bb0bd%3A0x97c9d163f170655c!2sClinica%20Dental%20La%20Merced%20-%20Sede%20Principal!5e0!3m2!1ses-419!2spe!4v1700307460927!5m2!1ses-419!2spe"
                                    allowFullScreen
                                ></iframe>
                            </div>
                        </div>
