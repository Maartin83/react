...
export async function getUser() {
    // El token es válido
    return await axios.get("http://localhost:8080/api/get/" + obtenerusername(), returnToken()).then((response) => {
...
export function getUserId() {
    ...
    return axios.get("http://localhost:8080/api/get/" + obtenerusername(), returnToken()).then((response) => {
        id=response.data.id;
        return id.toString();
    })
        .catch((error) => {
