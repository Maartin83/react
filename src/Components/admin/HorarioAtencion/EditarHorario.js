...
function EditarHorario(){
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:8080/api/horario/getid/${id}`, returnToken())
            .then((response) => {
        ...
        axios
            .get("http://localhost:8080/api/doctor/getall", returnToken())
            .then((response) => {
    ...
    const handleEditarHorario = (e) => {
        ...
        axios
            .put(`http://localhost:8080/api/horario/update`, horarioData, returnTokenJson())
            .then(async (response) => {
